...
print('4. 10.0 mbar')
print('')
print('If wanted, the probes an be adjusted in value and number. The correct mbar for the probes has to be given as user input.')
print('The code will ask for one probe too much. Please give any float as input for the last asked user input. [I am working on it]')
print('')
        ...
        if client.connect():  # Trying to connect to Modbus Server/Slave
            ...
            if not res.isError():  # If Registers don't show Error
                ...
                if counter1 == 6:
                    ...
                    print('If this was your last probe, give (now) any float') #maybe need to write more specific instruction
