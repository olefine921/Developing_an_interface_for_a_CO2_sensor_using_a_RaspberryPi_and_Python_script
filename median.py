...
while counter1 < 8:
    ...
    if client.connect():  # Trying to connect to Modbus Server/Slave
        ...
        first_reading = decoder.decode_32bit_float()  # reads & translates the 1. chanel
        second_reading = decoder.decode_32bit_float()  # reads & translates the 2. chanel
        third_reading = decoder.decode_32bit_float()  # reads & translates the 3. chanel
